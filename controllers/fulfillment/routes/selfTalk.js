...
selfTalk = async (agent) => {
    ...
    agent.add("For this technique, you're going to practice working through your cravings, out loud.")
    agent.add("The goal of self-talk is to transform your cravings into something you can manage, by verbalizing them.")
